...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    createYourOwnSkillDescription:
      "Create your own skill to release the power of Libra. With customized skills,\nLibra can help you with literature review, paper reproduction, data analysis,\n and academic writing — almost anything in your research workflow.",
  },
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. Libra is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but Libra could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "Libra project page",
    githubTooltip: "Libra on GitHub",
    settingsAndMore: "Settings and more",
    visitGithub: "Libra on GitHub",
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to Libra",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate Libra faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how Libra looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "Libra automatically learns from your conversations in the background. These memories help Libra understand you better and deliver a more personalized experience.",
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of Libra.",
      emptyButton: "Create Your First Skill",
    },
    notification: {
      title: "Notification",
      description:
        "Libra only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
