...
description: This tutorial walks you through your first complete agent conversation in Libra — from launching the app to getting meaningful work done with the agent.
---
...
This tutorial walks you through your first complete agent conversation in Libra — from launching the app to getting meaningful work done with the agent.

## Prerequisites

- Libra app is running (see [Quick Start](/docs/application/quick-start))
