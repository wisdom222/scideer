...
description: This tutorial shows you how to enable and use Libra's memory system so the agent remembers important information about you across multiple sessions.
---
...
This tutorial shows you how to enable and use Libra's memory system so the agent remembers important information about you across multiple sessions.
...
Memory is stored in `backend/.scideer/memory.json`:

```bash
cat backend/.scideer/memory.json
```
...
```
backend/.scideer/agents/{agent_name}/memory.json
```
