...
<Callout type="info" emoji="📦">
  ...
  command-based work. It is what makes Libra capable of real action, not just
  conversation.
</Callout>
...
Libra supports three sandbox modes. Choose the one that fits your deployment:
...
sandbox:
  ...
  # Optional: container name prefix (default: scideer-sandbox)
...
| `.scideer/threads/{thread_id}/user-data/` | `/mnt/user-data/`                            | Read-write |
