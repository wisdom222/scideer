...
Libra ships with the following public skills:
...
- **Through the Application UI**: the skills panel lets you toggle skills on and off.
...
Libra includes an optional **skill evolution** feature that allows the agent to autonomously create and improve skills in the `skills/custom/` directory:
