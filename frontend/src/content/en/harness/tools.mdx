...
<Callout type="info" emoji="🔧">
  Tools are the actions the Lead Agent can take. Libra provides built-in
...
Libra organizes tools into four categories:
...
Install: `cd backend && uv add 'libra-harness[tavily]'`
...
Install: `cd backend && uv add 'libra-harness[exa]'`
...
Install: `cd backend && uv add 'libra-harness[firecrawl]'`
