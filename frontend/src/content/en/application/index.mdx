---
title: Application
description: Application is the reference implementation of what a production Libra experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
---
...
<Callout type="info" emoji="🚀">
  Application is a complete Super Agent application built on top of Libra
...
Application is the reference implementation of what a production Libra experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
...
The Application runs as four services behind a single nginx reverse proxy:
...
- **LangGraph**: the Harness runtime. Manages thread state, agent execution, and streaming.
...
| Agent runtime     | LangGraph, LangChain, Harness                               |
| Reverse proxy     | nginx                                                                |
