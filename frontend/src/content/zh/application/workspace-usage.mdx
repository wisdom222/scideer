---
title: 工作区使用
description: Libra 工作区是一个基于浏览器的对话界面，你可以在其中向 Agent 发送消息、上传文件、查看中间步骤，以及下载生成的产出物。
---
...
Libra 工作区是一个基于浏览器的对话界面，你可以在其中向 Agent 发送消息、上传文件、查看中间步骤，以及下载生成的产出物。
...
产出物会持久保存在线程的用户数据目录中（`.scideer/threads/{thread_id}/user-data/outputs/`）。
